    ...
    <div class="container-marketing">
        ...
        <div class="row-front">
            <div class="col-md-6">
                ...
                world come to Berkeley to participate in Berkeley Model United Nations. Entering its 63rd 
        ...
        <div class="row-front">
            <div class="col-md-6">
                <img class="featurette-image img-responsive" src="img/head_chairs.jpg">
            </div>
            <div class="col-md-6">
